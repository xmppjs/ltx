...
var SaxLtx = module.exports = function SaxLtx () {
  ...
  this._isDecodable = function (data) {
    return data && typeof TextDecoder !== 'undefined' &&
      (
        (typeof Buffer === 'function' && Buffer.isBuffer(data)) ||
        (typeof ArrayBuffer === 'function' && (data instanceof ArrayBuffer || Object.prototype.toString.call(data) === '[object ArrayBuffer]' || ArrayBuffer.isView(data)))
      )
  }

  this.write = function (data) {
    if (typeof data !== 'string') {
      if (this._isDecodable(data)) {
        if (!decoder) {
          decoder = new TextDecoder('utf-8')
        }
        data = decoder.decode(data, { stream: !this.isLastChunk })
      } else {
        data = data.toString()
      }
    }
