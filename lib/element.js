...
/**
 * Get all child elements optionally matching `name` and
 * `xmlns`.  If `name` is omitted, all child elements 
 * will be returned (and text nodes will be excluded.)
 * If `xmlns` is omitted, matching will ignore namespace.
 **/
