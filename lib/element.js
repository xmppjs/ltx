 ...
 * xmlns can be null
 **/
Element.prototype.getChild = function(name, xmlns, recursive) {
    return this.getChildren(name, xmlns, recursive)[0];
};

/**
 * xmlns can be null
 **/
Element.prototype.getChildren = function(name, xmlns, recursive) {
 ...
 * xmlns can be null
 **/
Element.prototype.getChildByText = function(txt, xmlns, recursive) {
    return this.getChildrenByText(txt, xmlns, recursive)[0];
};

/**
 * xmlns can be null
 **/
Element.prototype.getChildrenByText = function(txt, xmlns, recursive) {
  return this.getChildrenByFilter(function(child){
    return (child.children &&
            child.children[0] == txt &&
            (!xmlns || child.getNS() == xmlns))
  }, recursive);
};
